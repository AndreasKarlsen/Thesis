...
\documentclass[a4paper,11pt,fleqn,openany,oneside]{memoir} %one side for pdf
...
\lstset{
  ...
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, out, ref, string},
...
\font\fontcode=pcrr at 11pt

\newcommand{\bscode}[1]{
	{\kern-0.3em \fontcode#1\kern-0.3em}
}
...
\newcommand{\bnfnonterm}[1]{
	\ensuremath{\text{\textless#1\textgreater{}}\,}
}

%\newcommand{\bnfrepeat}[1]{
%	\ensuremath{\{\,#1\}}
%}
...
\newcommand{\bnfgroup}[1]{
	\ensuremath{\left(\,#1\right)}
}

\newcommand{\bnfselect}[2]{
	\ensuremath{#1\text{\textbar{}}\,#2}
}

\newcommand{\bnfepsilon}[0]{
	\ensuremath{\mathcal{E}}
}

\newcommand{\bnfmetavar}[1]{
	\ensuremath{\mathsf{#1}\,}
}
...
\newcommand{\englishprojectinfo}[6]{%
  \parbox[t]{\titlepageleftcolumnwidth}{
    ...
    \textbf{Page Numbers:} 122 + 2 appendices\bigskip\par%old: \pageref{LastPage}\bigskip\par
...
%STM name
\newcommand{\stmname}{AC\#\xspace}
\newcommand{\stmnamesp}{AC\# }
