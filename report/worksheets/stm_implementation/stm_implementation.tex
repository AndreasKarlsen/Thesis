...
As described in \bsref{sec:stm_requirements} the \ac{STM} system must support strong atomicity. To that end the \ac{STM} system is able to detect whether or not read and write operations occur as transactional or non-transactional and the take the appropriate actions.
