...
\toby[i]{Måske forklar stmabortexeption? at den bruges til at aborte med (den er ikke introduceret før, tror jeg) og kort forklar hvad de enkelte ting der bliver tjekket for i if conditionen (Er TimeStamp transaktionens timestamp?).}
