...
\begin{lstlisting}[label=lst:impl_dining_lock,
  ...
  escapechar=~,
  morekeywords={atomic, retry, orelse, var, get, set, ref, out, readonly, virtual, override, lock, object}]  % Start your code-block
...
\begin{lstlisting}[label=lst:impl_queue_lock,
  ...
  stringstyle=\color{redstrings},
  escapechar=~,
  morekeywords={atomic, retry, orelse, var, get, set, ref, out, readonly, virtual, override, lock, object, bool}]  % Start your code-block
...
\begin{lstlisting}[label=lst:impl_hashmap_lock,
  ...
  stringstyle=\color{redstrings},
  escapechar=~,
  morekeywords={atomic, retry, orelse, var, get, set, ref, out, readonly, virtual, override, region, endregion, foreach, lock, object, bool, internal}]  % Start your code-block
  ...
  public class LockingHashMap<K,V> : BaseHashMap<K,V>
  {
    ...
    private LockingHashMap(int size, int nrLocks)
    {
      if (size % nrLocks != 0)
      {
        throw new Exception("The intital size % nrlocks must be equal to zero");
      }
...
\begin{lstlisting}[label=lst:impl_dining_lib,
  ...
  stringstyle=\color{redstrings},
  escapechar=~,
  morekeywords={atomic, retry, orelse, var, get, set, ref, out, readonly, virtual, override, region, endregion, foreach, lock, bool}]  % Start your code-block
...
\begin{lstlisting}[label=lst:impl_santa_lib,
  ...
  stringstyle=\color{redstrings},
  escapechar=~,
  morekeywords={atomic, retry, orelse, var, get, set, ref, out, readonly, virtual, override, region, endregion, foreach, lock, bool, object}]  % Start your code-block
