...
This chapter describes the requirements for the \ac{STM} system powering \stmname. The requirements are based on known \ac{STM} as well as the criteria for which the final system must be evaluated. Implementation details are described in \bsref{chap:implementation}.
