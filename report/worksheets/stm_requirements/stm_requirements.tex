...
\kasper[inline]{Should properly say that because internal changes are not tracked the reusability of existing libraries is limited. They will have to be rewritten using transaction if tracking of internal changes is needed.}
