...
A disadvantage of providing the \bscode{retry} and \bscode{orElse} constructs is increased complexity. However, as the \bscode{retry} and \bscode{orElse} constructs are optional, this disadvantage is negligible. Therefore the conditional synchronization constructs are included in \stmname.
