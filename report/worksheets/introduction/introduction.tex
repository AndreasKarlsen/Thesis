...
\andreas[inline]{Should we mention the cavaets of STM? Sideeffects}
...
% The increase of CPU speed is in additional cores - \cite{sutter2005free}
% Requires concurrent programming to utilize - \cite{sutter2005software}
% Programming for shared-memory concurrency is difficoult - 
% Resent studies done by \cite{dpt907e14trending} compares different techniques
% STM eases shared memory concurrency
% No breakthrough in major language. (Folk vil ikke skifte sprog eller paradigme for at få en anden concurrency tilgang)
% Not integrated in C#, only implemented as library
