...
\bsref{lst:design_value_parameter} presents a example of a atomic value parameter declaration.
...
\bsref{lst:atomic_ref} presents a example of a \bscode{Point} class declaring two \ac{TRP}'s as parameters for the \bscode{ChangeMe} method.
