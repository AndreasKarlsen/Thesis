...
There exists two types of syntax tress in Roslyn: green trees and red trees. The reason for this is that they would like a primary data structure with the following characteristics:

\paragraph{The green tree} bla bla

\paragraph{The red tree} bla bla
