...
The first phase of compilation involves doing initial work, such as parsing command line with associated parameters and setting up for compilation, as shown in \bsref{fig:roslyn_invoke_overview}. 
