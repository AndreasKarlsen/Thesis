...
\lone[i]{Afslutnings kapitel: Dermed kan vi ændre BLA BLA for at integere \stmname via Roslyn.}
\toby[i]{Måske kan vi undvære kapitlet, med det der er skrevet i starten af kapitlet?}
