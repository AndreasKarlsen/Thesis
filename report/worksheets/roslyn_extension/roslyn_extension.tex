...
\begin{lstlisting}[float,label=lst:roslyn_extension_tre_xml,
...
\begin{lstlisting}[float,label=lst:parse_atomic_block,
...
\begin{lstlisting}[float,label=lst:before_atomic_block,
...
\begin{lstlisting}[float,label=lst:after_atomic_block,
...
\begin{lstlisting}[float, label=lst:before_atomic_field,
...
\begin{lstlisting}[float, label=lst:after_atomic_field,
...
\begin{lstlisting}[float, label=lst:before_atomic_property,
...
\begin{lstlisting}[float, label=lst:after_atomic_property,
...
\begin{lstlisting}[float, label=lst:before_atomic_variable,
...
\begin{lstlisting}[float, label=lst:after_atomic_variable,
...
\begin{lstlisting}[float, label=lst:before_atomic_usage,
...
\begin{lstlisting}[float, label=lst:after_atomic_usage,
...
\begin{lstlisting}[float, label=lst:before_atomic_parameter,
...
\begin{lstlisting}[float, label=lst:after_atomic_parameter,
...
\begin{lstlisting}[float, label=lst:before_atomic_out_parameter,
...
\begin{lstlisting}[float, label=lst:after_atomic_out_parameter,
...
\begin{lstlisting}[float, label=lst:before_atomic_argument,
...
\begin{lstlisting}[float, label=lst:after_atomic_argument,
...
\begin{lstlisting}[float, label=lst:before_atomic_ref,
...
\begin{lstlisting}[float, label=lst:after_atomic_ref,
