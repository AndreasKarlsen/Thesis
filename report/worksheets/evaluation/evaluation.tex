...
With respect to simplicity locking in C\# is, as described in \bsref{subsec:simplicity}, placed close to the low simplicity end of the spectrum mainly due the the number of errors that can arise. This negatively impacts the approach's readability. The \ac{STM} library is placed The two \ac{STM} based approaches are placed just above the middle of while \stmname resides further towards the high simplicity end of the spectrum.
