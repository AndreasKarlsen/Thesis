...
\begin{itemize}
	\item Follow the requirements defined in \cite{trono1994new} while still utilizing advantageous features of the approach.
\end{itemize}
...
\end{itemize}
 ...
 The dining philosophers implementations must include
