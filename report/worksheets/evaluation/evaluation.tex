...
In \bsref{subsec:simplicity} the simplicity of locking is placed close to the low simplicity extreme, where the \ac{STM} library is placed a bit higher than the middle of the spectrum and \stmname even higher. In \bsref{subsec:orthogonality} the orthogonality of locking resides between the middle and high end of the spectrum, while library-based \ac{STM} is placed just above the middle of of the spectrum with \stmname just above it. These characteristics directly influence the readability of the concurrency approaches.
