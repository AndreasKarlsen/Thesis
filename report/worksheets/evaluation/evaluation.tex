...
%problematic to predict the performance of transactions

\toby[i]{Fortæl om stm lib og \stmname individuelt - hiv det med data typer op til at beskrive om det og også syntax design (evt. står der også noget om det i expressivity)}

The placement of the three concurrency approaches on the low readability - high readability spectrum is depicted in \bsref{fig:char_readability}.

\toby[i]{Evt. også inddrag noget syntax design karakteristikken, når den er lavet}
